...
const Resume = () => {
  return (
    ...
    <h3>Resume</h3>
      <h4>JourneyPure</h4>
      <h5>July 2020 : August 2020 | Admissions Coordinator</h5>
      <p>
      ...
      <p>
        ...
        through group and individual projects reflecting real-world business
        problems
        <br />
      </p>
      <h4>Murphy’s Motor Works</h4>
      <h5>August 2013 : March 2019 | Owner</h5>
      <p>
        ...
        fabrication <br />
        - Managed expected repair time per vehicle due to
        having a small shop with lots of customers with varying repair times{" "}<br />
        - Wired CAT5/CAT6 surveillance/networking systems and 3 phase 220v
        machinery <br />
        - Solved simple shop issues with a Raspberry Pi and
        running PiHole on the network router to have an ad-free YouTube channel
        for the shop
      </p>
      <h4>Rook Industries</h4>
      <h5>January 2012 : June 2013 | Product design and
        fabrication - Co-owner</h5>
      <p>
      ...
      <h4>USA Motor and Machine</h4>
      <h5>January 2009 : January 2012 | Machinest/Import Specialist</h5>
      <p>
      ...
      <h3>Education</h3>
      <h4>- Nashville State Community College | Mechanical Engineering - Current</h4>
      <h4>- Nashville Software School | Full Stack Software Engineer - 2019</h4>
      <h4>
